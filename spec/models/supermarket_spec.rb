...
RSpec.describe Supermarket, type: :model do
  ...
  describe 'instance methods' do 
    describe '#unique_items' do 
      it 'returns the names of the items sold at the supermarket' do 
    ...
    describe '#top_3_items' do 
      it 'returns the top 3 items' do 
        ...
        actual = supermarket_1.top_3_items.map do |item| 
          item.item_name 
        end

        expected = [item_1, item_2, item_4].map do |item|
          item.name 
        end
